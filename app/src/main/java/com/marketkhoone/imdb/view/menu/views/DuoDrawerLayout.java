...
//    private static final String TAG_CARD_VIEW = "cardView";
//    private static final String TAG_CARD_VIEW_SHADOW= "cardViewShadow";
//    private static final String TAG_OVERLAY = "overlay";
//
//    @LayoutRes
//    private static final int DEFAULT_ATTRIBUTE_VALUE = -54321;
//    private static final float CONTENT_SCALE_CLOSED = 1.0f;
//    private static final float CONTENT_SCALE_OPEN = 0.6f;
//    private static final float CLICK_TO_CLOSE_SCALE = 0.6f;
...
//    private DuoDrawerLayout.ViewDragCallback mViewDragCallback;
//
//    private View mContentView;
//    private View mShadowView;
//    private View mMenuView;
//    private CardView mShadowViewCardView;
//    private CardView mContentViewCardView;
//
...
//        mViewDragCallback = new DuoDrawerLayout.ViewDragCallback();
...
//
//        mShadowView.offsetLeftAndRight((int) mDraggedXOffset - 88);
//        mShadowView.offsetTopAndBottom((int) mDraggedYOffset - 40);
//    }
//
//
//    /**
...
//                    mMenuView = view;
//                }else if (tag.equals(TAG_CARD_VIEW_SHADOW)) {
//                    mShadowView = view;
...
//
//            float scaleOffset = (1 - scaleFactorContent) * 10;
//
//            mContentView.setRotation(scaleOffset * -2);
//
//            mContentViewCardView.setRadius((scaleOffset * 15) + 1);
//
//            mShadowView.setScaleX(scaleFactorContent + (scaleOffset * 0.007f));
//            mShadowView.setScaleY(scaleFactorContent + (scaleOffset * 0.007f));
//
//            mShadowView.setLeft(mContentView.getLeft() - (int)(scaleOffset * 22));
//            mShadowView.setRight(mContentView.getRight() - (int)(scaleOffset * 22));
//            mShadowView.setBottom(mContentView.getBottom() - (int)(scaleOffset * 10));
//
//            mShadowView.setRotation(scaleOffset * -4f);
//            mShadowViewCardView.setRadius((scaleOffset * 15) + 1);
//
