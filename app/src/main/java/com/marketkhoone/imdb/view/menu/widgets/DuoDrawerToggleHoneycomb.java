...
//    };
//
//    public static DuoDrawerToggleHoneycomb.SetIndicatorInfo setActionBarUpIndicator(DuoDrawerToggleHoneycomb.SetIndicatorInfo info, Activity activity, Drawable drawable, int contentDescRes) {
//        if (true || info == null) {
//            info = new DuoDrawerToggleHoneycomb.SetIndicatorInfo(activity);
//        }
...
//    }
//
//    public static DuoDrawerToggleHoneycomb.SetIndicatorInfo setActionBarDescription(DuoDrawerToggleHoneycomb.SetIndicatorInfo info, Activity activity,
//                                                                                                                              int contentDescRes) {
//        if (info == null) {
//            info = new DuoDrawerToggleHoneycomb.SetIndicatorInfo(activity);
//        }
