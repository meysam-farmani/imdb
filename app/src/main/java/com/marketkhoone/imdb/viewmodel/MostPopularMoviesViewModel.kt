...
class MostPopularMoviesViewModel(application: Application): AndroidViewModel(application) {
    ...
    fun getData(){
        ...
        getMostPopularMovies(apiKey)
    }

    private fun getMostPopularMovies(apiKey: String){
        disposable.add(
